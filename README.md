...
2. Enter your DeepSeek Key in the `MACM/utils/gpt_robots.py` line 4,the `MACM/utils/gpt.py` line 4,the `MACM/io/io.py` line 7. Enter your question in the `MACM/main.py` line 225. If you don't enter your question, there will be a `Error processing file` error.
